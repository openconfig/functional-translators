...
// OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv4_Config_Protocol_Union is an interface that is implemented by valid types for the union
// for the leaf /openconfig-qos/qos/classifiers/classifier/terms/term/conditions/ipv4/config/protocol within the YANG schema.
// Union type can be one of [E_OpenconfigPacketMatchTypes_IP_PROTOCOL, UnionUint8].
type OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv4_Config_Protocol_Union interface {
	// Union type can be one of [E_OpenconfigPacketMatchTypes_IP_PROTOCOL, UnionUint8]
	Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv4_Config_Protocol_Union()
}

// Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv4_Config_Protocol_Union ensures that E_OpenconfigPacketMatchTypes_IP_PROTOCOL
// implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv4_Config_Protocol_Union interface.
func (E_OpenconfigPacketMatchTypes_IP_PROTOCOL) Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv4_Config_Protocol_Union() {
}

// Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv4_Config_Protocol_Union ensures that UnionUint8
// implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv4_Config_Protocol_Union interface.
func (UnionUint8) Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv4_Config_Protocol_Union() {
}

// To_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv4_Config_Protocol_Union takes an input interface{} and attempts to convert it to a struct
// which implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv4_Config_Protocol_Union union. It returns an error if the interface{} supplied
// cannot be converted to a type within the union.
func (t *OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv4_Config) To_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv4_Config_Protocol_Union(i interface{}) (OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv4_Config_Protocol_Union, error) {
	if v, ok := i.(OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv4_Config_Protocol_Union); ok {
		return v, nil
	}
	switch v := i.(type) {
	case uint8:
	...
	return nil, fmt.Errorf("cannot convert %v to OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv4_Config_Protocol_Union, unknown union type, got: %T, want any of [E_OpenconfigPacketMatchTypes_IP_PROTOCOL, uint8]", i, i)
}

// OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv4_State_Protocol_Union is an interface that is implemented by valid types for the union
// for the leaf /openconfig-qos/qos/classifiers/classifier/terms/term/conditions/ipv4/state/protocol within the YANG schema.
// Union type can be one of [E_OpenconfigPacketMatchTypes_IP_PROTOCOL, UnionUint8].
type OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv4_State_Protocol_Union interface {
	// Union type can be one of [E_OpenconfigPacketMatchTypes_IP_PROTOCOL, UnionUint8]
	Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv4_State_Protocol_Union()
}

// Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv4_State_Protocol_Union ensures that E_OpenconfigPacketMatchTypes_IP_PROTOCOL
// implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv4_State_Protocol_Union interface.
func (E_OpenconfigPacketMatchTypes_IP_PROTOCOL) Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv4_State_Protocol_Union() {
}

// Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv4_State_Protocol_Union ensures that UnionUint8
// implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv4_State_Protocol_Union interface.
func (UnionUint8) Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv4_State_Protocol_Union() {
}

// To_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv4_State_Protocol_Union takes an input interface{} and attempts to convert it to a struct
// which implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv4_State_Protocol_Union union. It returns an error if the interface{} supplied
// cannot be converted to a type within the union.
func (t *OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv4_State) To_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv4_State_Protocol_Union(i interface{}) (OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv4_State_Protocol_Union, error) {
	if v, ok := i.(OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv4_State_Protocol_Union); ok {
		return v, nil
	}
	switch v := i.(type) {
	case uint8:
	...
	return nil, fmt.Errorf("cannot convert %v to OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv4_State_Protocol_Union, unknown union type, got: %T, want any of [E_OpenconfigPacketMatchTypes_IP_PROTOCOL, uint8]", i, i)
}

// OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv6_Config_Protocol_Union is an interface that is implemented by valid types for the union
// for the leaf /openconfig-qos/qos/classifiers/classifier/terms/term/conditions/ipv6/config/protocol within the YANG schema.
// Union type can be one of [E_OpenconfigPacketMatchTypes_IP_PROTOCOL, UnionUint8].
type OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv6_Config_Protocol_Union interface {
	// Union type can be one of [E_OpenconfigPacketMatchTypes_IP_PROTOCOL, UnionUint8]
	Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv6_Config_Protocol_Union()
}

// Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv6_Config_Protocol_Union ensures that E_OpenconfigPacketMatchTypes_IP_PROTOCOL
// implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv6_Config_Protocol_Union interface.
func (E_OpenconfigPacketMatchTypes_IP_PROTOCOL) Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv6_Config_Protocol_Union() {
}

// Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv6_Config_Protocol_Union ensures that UnionUint8
// implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv6_Config_Protocol_Union interface.
func (UnionUint8) Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv6_Config_Protocol_Union() {
}

// To_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv6_Config_Protocol_Union takes an input interface{} and attempts to convert it to a struct
// which implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv6_Config_Protocol_Union union. It returns an error if the interface{} supplied
// cannot be converted to a type within the union.
func (t *OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv6_Config) To_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv6_Config_Protocol_Union(i interface{}) (OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv6_Config_Protocol_Union, error) {
	if v, ok := i.(OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv6_Config_Protocol_Union); ok {
		return v, nil
	}
	switch v := i.(type) {
	case uint8:
	...
	return nil, fmt.Errorf("cannot convert %v to OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv6_Config_Protocol_Union, unknown union type, got: %T, want any of [E_OpenconfigPacketMatchTypes_IP_PROTOCOL, uint8]", i, i)
}

// OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv6_State_Protocol_Union is an interface that is implemented by valid types for the union
// for the leaf /openconfig-qos/qos/classifiers/classifier/terms/term/conditions/ipv6/state/protocol within the YANG schema.
// Union type can be one of [E_OpenconfigPacketMatchTypes_IP_PROTOCOL, UnionUint8].
type OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv6_State_Protocol_Union interface {
	// Union type can be one of [E_OpenconfigPacketMatchTypes_IP_PROTOCOL, UnionUint8]
	Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv6_State_Protocol_Union()
}

// Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv6_State_Protocol_Union ensures that E_OpenconfigPacketMatchTypes_IP_PROTOCOL
// implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv6_State_Protocol_Union interface.
func (E_OpenconfigPacketMatchTypes_IP_PROTOCOL) Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv6_State_Protocol_Union() {
}

// Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv6_State_Protocol_Union ensures that UnionUint8
// implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv6_State_Protocol_Union interface.
func (UnionUint8) Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv6_State_Protocol_Union() {
}

// To_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv6_State_Protocol_Union takes an input interface{} and attempts to convert it to a struct
// which implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv6_State_Protocol_Union union. It returns an error if the interface{} supplied
// cannot be converted to a type within the union.
func (t *OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv6_State) To_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv6_State_Protocol_Union(i interface{}) (OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv6_State_Protocol_Union, error) {
	if v, ok := i.(OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv6_State_Protocol_Union); ok {
		return v, nil
	}
	switch v := i.(type) {
	case uint8:
	...
	return nil, fmt.Errorf("cannot convert %v to OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Ipv6_State_Protocol_Union, unknown union type, got: %T, want any of [E_OpenconfigPacketMatchTypes_IP_PROTOCOL, uint8]", i, i)
}

// OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_L2_Config_Ethertype_Union is an interface that is implemented by valid types for the union
// for the leaf /openconfig-qos/qos/classifiers/classifier/terms/term/conditions/l2/config/ethertype within the YANG schema.
// Union type can be one of [E_OpenconfigPacketMatchTypes_ETHERTYPE, UnionUint16].
type OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_L2_Config_Ethertype_Union interface {
	// Union type can be one of [E_OpenconfigPacketMatchTypes_ETHERTYPE, UnionUint16]
	Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_L2_Config_Ethertype_Union()
}

// Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_L2_Config_Ethertype_Union ensures that E_OpenconfigPacketMatchTypes_ETHERTYPE
// implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_L2_Config_Ethertype_Union interface.
func (E_OpenconfigPacketMatchTypes_ETHERTYPE) Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_L2_Config_Ethertype_Union() {
}

// Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_L2_Config_Ethertype_Union ensures that UnionUint16
// implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_L2_Config_Ethertype_Union interface.
func (UnionUint16) Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_L2_Config_Ethertype_Union() {
}

// To_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_L2_Config_Ethertype_Union takes an input interface{} and attempts to convert it to a struct
// which implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_L2_Config_Ethertype_Union union. It returns an error if the interface{} supplied
// cannot be converted to a type within the union.
func (t *OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_L2_Config) To_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_L2_Config_Ethertype_Union(i interface{}) (OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_L2_Config_Ethertype_Union, error) {
	if v, ok := i.(OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_L2_Config_Ethertype_Union); ok {
		return v, nil
	}
	switch v := i.(type) {
	case uint16:
	...
	return nil, fmt.Errorf("cannot convert %v to OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_L2_Config_Ethertype_Union, unknown union type, got: %T, want any of [E_OpenconfigPacketMatchTypes_ETHERTYPE, uint16]", i, i)
}

// OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_L2_State_Ethertype_Union is an interface that is implemented by valid types for the union
// for the leaf /openconfig-qos/qos/classifiers/classifier/terms/term/conditions/l2/state/ethertype within the YANG schema.
// Union type can be one of [E_OpenconfigPacketMatchTypes_ETHERTYPE, UnionUint16].
type OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_L2_State_Ethertype_Union interface {
	// Union type can be one of [E_OpenconfigPacketMatchTypes_ETHERTYPE, UnionUint16]
	Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_L2_State_Ethertype_Union()
}

// Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_L2_State_Ethertype_Union ensures that E_OpenconfigPacketMatchTypes_ETHERTYPE
// implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_L2_State_Ethertype_Union interface.
func (E_OpenconfigPacketMatchTypes_ETHERTYPE) Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_L2_State_Ethertype_Union() {
}

// Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_L2_State_Ethertype_Union ensures that UnionUint16
// implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_L2_State_Ethertype_Union interface.
func (UnionUint16) Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_L2_State_Ethertype_Union() {
}

// To_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_L2_State_Ethertype_Union takes an input interface{} and attempts to convert it to a struct
// which implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_L2_State_Ethertype_Union union. It returns an error if the interface{} supplied
// cannot be converted to a type within the union.
func (t *OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_L2_State) To_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_L2_State_Ethertype_Union(i interface{}) (OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_L2_State_Ethertype_Union, error) {
	if v, ok := i.(OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_L2_State_Ethertype_Union); ok {
		return v, nil
	}
	switch v := i.(type) {
	case uint16:
	...
	return nil, fmt.Errorf("cannot convert %v to OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_L2_State_Ethertype_Union, unknown union type, got: %T, want any of [E_OpenconfigPacketMatchTypes_ETHERTYPE, uint16]", i, i)
}

// OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_Config_EndLabelValue_Union is an interface that is implemented by valid types for the union
...
// Union type can be one of [E_OpenconfigMplsTypes_MplsLabel_Enum, UnionUint32].
type OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_Config_EndLabelValue_Union interface {
	// Union type can be one of [E_OpenconfigMplsTypes_MplsLabel_Enum, UnionUint32]
	Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_Config_EndLabelValue_Union()
}

// Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_Config_EndLabelValue_Union ensures that E_OpenconfigMplsTypes_MplsLabel_Enum
// implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_Config_EndLabelValue_Union interface.
func (E_OpenconfigMplsTypes_MplsLabel_Enum) Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_Config_EndLabelValue_Union() {
}

// Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_Config_EndLabelValue_Union ensures that UnionUint32
// implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_Config_EndLabelValue_Union interface.
func (UnionUint32) Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_Config_EndLabelValue_Union() {
}

// To_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_Config_EndLabelValue_Union takes an input interface{} and attempts to convert it to a struct
// which implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_Config_EndLabelValue_Union union. It returns an error if the interface{} supplied
// cannot be converted to a type within the union.
func (t *OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_Config) To_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_Config_EndLabelValue_Union(i interface{}) (OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_Config_EndLabelValue_Union, error) {
	if v, ok := i.(OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_Config_EndLabelValue_Union); ok {
		return v, nil
	}
	switch v := i.(type) {
	case uint32:
	...
	return nil, fmt.Errorf("cannot convert %v to OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_Config_EndLabelValue_Union, unknown union type, got: %T, want any of [E_OpenconfigMplsTypes_MplsLabel_Enum, uint32]", i, i)
}

// OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_Config_StartLabelValue_Union is an interface that is implemented by valid types for the union
...
// Union type can be one of [E_OpenconfigMplsTypes_MplsLabel_Enum, UnionUint32].
type OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_Config_StartLabelValue_Union interface {
	// Union type can be one of [E_OpenconfigMplsTypes_MplsLabel_Enum, UnionUint32]
	Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_Config_StartLabelValue_Union()
}

// Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_Config_StartLabelValue_Union ensures that E_OpenconfigMplsTypes_MplsLabel_Enum
// implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_Config_StartLabelValue_Union interface.
func (E_OpenconfigMplsTypes_MplsLabel_Enum) Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_Config_StartLabelValue_Union() {
}

// Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_Config_StartLabelValue_Union ensures that UnionUint32
// implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_Config_StartLabelValue_Union interface.
func (UnionUint32) Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_Config_StartLabelValue_Union() {
}

// To_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_Config_StartLabelValue_Union takes an input interface{} and attempts to convert it to a struct
// which implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_Config_StartLabelValue_Union union. It returns an error if the interface{} supplied
// cannot be converted to a type within the union.
func (t *OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_Config) To_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_Config_StartLabelValue_Union(i interface{}) (OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_Config_StartLabelValue_Union, error) {
	if v, ok := i.(OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_Config_StartLabelValue_Union); ok {
		return v, nil
	}
	switch v := i.(type) {
	case uint32:
	...
	return nil, fmt.Errorf("cannot convert %v to OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_Config_StartLabelValue_Union, unknown union type, got: %T, want any of [E_OpenconfigMplsTypes_MplsLabel_Enum, uint32]", i, i)
}

// OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_State_EndLabelValue_Union is an interface that is implemented by valid types for the union
...
// Union type can be one of [E_OpenconfigMplsTypes_MplsLabel_Enum, UnionUint32].
type OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_State_EndLabelValue_Union interface {
	// Union type can be one of [E_OpenconfigMplsTypes_MplsLabel_Enum, UnionUint32]
	Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_State_EndLabelValue_Union()
}

// Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_State_EndLabelValue_Union ensures that E_OpenconfigMplsTypes_MplsLabel_Enum
// implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_State_EndLabelValue_Union interface.
func (E_OpenconfigMplsTypes_MplsLabel_Enum) Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_State_EndLabelValue_Union() {
}

// Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_State_EndLabelValue_Union ensures that UnionUint32
// implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_State_EndLabelValue_Union interface.
func (UnionUint32) Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_State_EndLabelValue_Union() {
}

// To_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_State_EndLabelValue_Union takes an input interface{} and attempts to convert it to a struct
// which implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_State_EndLabelValue_Union union. It returns an error if the interface{} supplied
// cannot be converted to a type within the union.
func (t *OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_State) To_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_State_EndLabelValue_Union(i interface{}) (OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_State_EndLabelValue_Union, error) {
	if v, ok := i.(OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_State_EndLabelValue_Union); ok {
		return v, nil
	}
	switch v := i.(type) {
	case uint32:
	...
	return nil, fmt.Errorf("cannot convert %v to OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_State_EndLabelValue_Union, unknown union type, got: %T, want any of [E_OpenconfigMplsTypes_MplsLabel_Enum, uint32]", i, i)
}

// OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_State_StartLabelValue_Union is an interface that is implemented by valid types for the union
...
// Union type can be one of [E_OpenconfigMplsTypes_MplsLabel_Enum, UnionUint32].
type OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_State_StartLabelValue_Union interface {
	// Union type can be one of [E_OpenconfigMplsTypes_MplsLabel_Enum, UnionUint32]
	Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_State_StartLabelValue_Union()
}

// Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_State_StartLabelValue_Union ensures that E_OpenconfigMplsTypes_MplsLabel_Enum
// implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_State_StartLabelValue_Union interface.
func (E_OpenconfigMplsTypes_MplsLabel_Enum) Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_State_StartLabelValue_Union() {
}

// Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_State_StartLabelValue_Union ensures that UnionUint32
// implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_State_StartLabelValue_Union interface.
func (UnionUint32) Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_State_StartLabelValue_Union() {
}

// To_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_State_StartLabelValue_Union takes an input interface{} and attempts to convert it to a struct
// which implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_State_StartLabelValue_Union union. It returns an error if the interface{} supplied
// cannot be converted to a type within the union.
func (t *OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_State) To_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_State_StartLabelValue_Union(i interface{}) (OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_State_StartLabelValue_Union, error) {
	if v, ok := i.(OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_State_StartLabelValue_Union); ok {
		return v, nil
	}
	switch v := i.(type) {
	case uint32:
	...
	return nil, fmt.Errorf("cannot convert %v to OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Mpls_State_StartLabelValue_Union, unknown union type, got: %T, want any of [E_OpenconfigMplsTypes_MplsLabel_Enum, uint32]", i, i)
}

// OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_Config_DestinationPort_Union is an interface that is implemented by valid types for the union
...
// Union type can be one of [E_OpenconfigPacketMatchTypes_PortNumRange_Enum, UnionString, UnionUint16].
type OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_Config_DestinationPort_Union interface {
	// Union type can be one of [E_OpenconfigPacketMatchTypes_PortNumRange_Enum, UnionString, UnionUint16]
	Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_Config_DestinationPort_Union()
}

// Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_Config_DestinationPort_Union ensures that E_OpenconfigPacketMatchTypes_PortNumRange_Enum
// implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_Config_DestinationPort_Union interface.
func (E_OpenconfigPacketMatchTypes_PortNumRange_Enum) Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_Config_DestinationPort_Union() {
}

// Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_Config_DestinationPort_Union ensures that UnionString
// implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_Config_DestinationPort_Union interface.
func (UnionString) Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_Config_DestinationPort_Union() {
}

// Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_Config_DestinationPort_Union ensures that UnionUint16
// implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_Config_DestinationPort_Union interface.
func (UnionUint16) Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_Config_DestinationPort_Union() {
}

// To_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_Config_DestinationPort_Union takes an input interface{} and attempts to convert it to a struct
// which implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_Config_DestinationPort_Union union. It returns an error if the interface{} supplied
// cannot be converted to a type within the union.
func (t *OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_Config) To_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_Config_DestinationPort_Union(i interface{}) (OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_Config_DestinationPort_Union, error) {
	if v, ok := i.(OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_Config_DestinationPort_Union); ok {
		return v, nil
	}
	switch v := i.(type) {
	case string:
	...
	return nil, fmt.Errorf("cannot convert %v to OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_Config_DestinationPort_Union, unknown union type, got: %T, want any of [E_OpenconfigPacketMatchTypes_PortNumRange_Enum, string, uint16]", i, i)
}

// OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_Config_SourcePort_Union is an interface that is implemented by valid types for the union
...
// Union type can be one of [E_OpenconfigPacketMatchTypes_PortNumRange_Enum, UnionString, UnionUint16].
type OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_Config_SourcePort_Union interface {
	// Union type can be one of [E_OpenconfigPacketMatchTypes_PortNumRange_Enum, UnionString, UnionUint16]
	Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_Config_SourcePort_Union()
}

// Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_Config_SourcePort_Union ensures that E_OpenconfigPacketMatchTypes_PortNumRange_Enum
// implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_Config_SourcePort_Union interface.
func (E_OpenconfigPacketMatchTypes_PortNumRange_Enum) Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_Config_SourcePort_Union() {
}

// Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_Config_SourcePort_Union ensures that UnionString
// implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_Config_SourcePort_Union interface.
func (UnionString) Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_Config_SourcePort_Union() {
}

// Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_Config_SourcePort_Union ensures that UnionUint16
// implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_Config_SourcePort_Union interface.
func (UnionUint16) Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_Config_SourcePort_Union() {
}

// To_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_Config_SourcePort_Union takes an input interface{} and attempts to convert it to a struct
// which implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_Config_SourcePort_Union union. It returns an error if the interface{} supplied
// cannot be converted to a type within the union.
func (t *OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_Config) To_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_Config_SourcePort_Union(i interface{}) (OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_Config_SourcePort_Union, error) {
	if v, ok := i.(OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_Config_SourcePort_Union); ok {
		return v, nil
	}
	switch v := i.(type) {
	case string:
	...
	return nil, fmt.Errorf("cannot convert %v to OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_Config_SourcePort_Union, unknown union type, got: %T, want any of [E_OpenconfigPacketMatchTypes_PortNumRange_Enum, string, uint16]", i, i)
}

// OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_State_DestinationPort_Union is an interface that is implemented by valid types for the union
...
// Union type can be one of [E_OpenconfigPacketMatchTypes_PortNumRange_Enum, UnionString, UnionUint16].
type OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_State_DestinationPort_Union interface {
	// Union type can be one of [E_OpenconfigPacketMatchTypes_PortNumRange_Enum, UnionString, UnionUint16]
	Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_State_DestinationPort_Union()
}

// Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_State_DestinationPort_Union ensures that E_OpenconfigPacketMatchTypes_PortNumRange_Enum
// implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_State_DestinationPort_Union interface.
func (E_OpenconfigPacketMatchTypes_PortNumRange_Enum) Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_State_DestinationPort_Union() {
}

// Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_State_DestinationPort_Union ensures that UnionString
// implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_State_DestinationPort_Union interface.
func (UnionString) Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_State_DestinationPort_Union() {
}

// Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_State_DestinationPort_Union ensures that UnionUint16
// implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_State_DestinationPort_Union interface.
func (UnionUint16) Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_State_DestinationPort_Union() {
}

// To_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_State_DestinationPort_Union takes an input interface{} and attempts to convert it to a struct
// which implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_State_DestinationPort_Union union. It returns an error if the interface{} supplied
// cannot be converted to a type within the union.
func (t *OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_State) To_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_State_DestinationPort_Union(i interface{}) (OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_State_DestinationPort_Union, error) {
	if v, ok := i.(OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_State_DestinationPort_Union); ok {
		return v, nil
	}
	switch v := i.(type) {
	case string:
	...
	return nil, fmt.Errorf("cannot convert %v to OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_State_DestinationPort_Union, unknown union type, got: %T, want any of [E_OpenconfigPacketMatchTypes_PortNumRange_Enum, string, uint16]", i, i)
}

// OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_State_SourcePort_Union is an interface that is implemented by valid types for the union
...
// Union type can be one of [E_OpenconfigPacketMatchTypes_PortNumRange_Enum, UnionString, UnionUint16].
type OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_State_SourcePort_Union interface {
	// Union type can be one of [E_OpenconfigPacketMatchTypes_PortNumRange_Enum, UnionString, UnionUint16]
	Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_State_SourcePort_Union()
}

// Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_State_SourcePort_Union ensures that E_OpenconfigPacketMatchTypes_PortNumRange_Enum
// implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_State_SourcePort_Union interface.
func (E_OpenconfigPacketMatchTypes_PortNumRange_Enum) Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_State_SourcePort_Union() {
}

// Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_State_SourcePort_Union ensures that UnionString
// implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_State_SourcePort_Union interface.
func (UnionString) Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_State_SourcePort_Union() {
}

// Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_State_SourcePort_Union ensures that UnionUint16
// implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_State_SourcePort_Union interface.
func (UnionUint16) Documentation_for_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_State_SourcePort_Union() {
}

// To_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_State_SourcePort_Union takes an input interface{} and attempts to convert it to a struct
// which implements the OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_State_SourcePort_Union union. It returns an error if the interface{} supplied
// cannot be converted to a type within the union.
func (t *OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_State) To_OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_State_SourcePort_Union(i interface{}) (OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_State_SourcePort_Union, error) {
	if v, ok := i.(OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_State_SourcePort_Union); ok {
		return v, nil
	}
	switch v := i.(type) {
	case string:
	...
	return nil, fmt.Errorf("cannot convert %v to OpenconfigQos_Qos_Classifiers_Classifier_Terms_Term_Conditions_Transport_State_SourcePort_Union, unknown union type, got: %T, want any of [E_OpenconfigPacketMatchTypes_PortNumRange_Enum, string, uint16]", i, i)
}
