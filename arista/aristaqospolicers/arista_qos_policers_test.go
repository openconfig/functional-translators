...
func TestTranslate(t *testing.T) {
	tests := []struct {
		...
		{
			name:           "LogicalInterfaceFirstMemberUpdate",
			inputPath:      "testdata/logical_interface_member1_input.txt",
			wantOutputPath: "testdata/logical_interface_member1_output.txt",
		},
		{
			name:           "LogicalInterfaceSecondMemberUpdateCalculatesAggregateSum",
			inputPath:      "testdata/logical_interface_member2_input.txt",
			wantOutputPath: "testdata/logical_interface_member2_output.txt",
		},
		{
			name:           "LogicalInterfaceMemberDeletionReducesSum",
			inputPath:      "testdata/logical_interface_delete1_input.txt",
			wantOutputPath: "testdata/logical_interface_delete1_output.txt",
		},
		{
			name:           "LogicalInterfaceMemberDeletionRemovesOCPath",
			inputPath:      "testdata/logical_interface_delete2_input.txt",
			wantOutputPath: "testdata/logical_interface_delete2_output.txt",
		},
		{
			name:           "OpenConfigShieldStripsDestructiveStateDeleteDuringReplace",
			inputPath:      "testdata/openconfig_replace_input.txt",
			wantOutputPath: "testdata/openconfig_replace_output.txt",
		},
		{
			name:           "OpenConfigShieldAllowsLegitimateStructuralDelete",
			inputPath:      "testdata/openconfig_legit_delete_input.txt",
			wantOutputPath: "testdata/openconfig_legit_delete_output.txt",
		},
		{
			name:      "SkipUpdateWithEmptyPathElements",
			inputPath: "testdata/empty_update_path_input.txt",
			wantNil:   true,
		},
		{
			name:      "SkipInvalidKeyWithoutUnderscore",
			inputPath: "testdata/invalid_key_no_underscore_input.txt",
			wantNil:   true,
		},
		{
			name:      "SkipPhysicalInterfaceWithEmptyAttachmentPoint",
			inputPath: "testdata/physical_interface_skip_input.txt",
			wantNil:   true,
		},
				{
			name:      "OpenConfigEmptyNotificationIsDropped",
			inputPath: "testdata/openconfig_empty_notification_input.txt",
			wantNil:   true,
		},
		{
			name:           "OpenConfigShortPathUpdateBypassesInterfaceLogic",
			inputPath:      "testdata/openconfig_short_path_update_input.txt",
			wantOutputPath: "testdata/openconfig_short_path_update_output.txt",
		},
		{
			name:           "OpenConfigPreservesNonSchedulerStateContainerDeletes",
			inputPath:      "testdata/openconfig_non_scheduler_state_delete_input.txt",
			wantOutputPath: "testdata/openconfig_non_scheduler_state_delete_output.txt",
		},
	}
